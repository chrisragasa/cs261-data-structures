...
{	
	...
	//Initialze the new array with new capacity
	...
	//Set the value of pointer v equal to the new DynArr
	*v = newArray;
...
{	
	...
	//If the current size of the array is equal to the capacity, resize the array
